...
export default async function CoursesPage({ params }: Props) {
  ...
  const messages = {
    ...
    durationLabel: t("courses.durationLabel"),
    groupSizeLabel: t("courses.groupSizeLabel"),
    sessionLengthLabel: t("courses.sessionLengthLabel"),
    scheduleLine: t("courses.scheduleLine"),
